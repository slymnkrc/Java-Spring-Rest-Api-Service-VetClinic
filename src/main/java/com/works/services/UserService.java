...
import com.works.repositories._jpa.JpaAccountActivityRepository;
...
public class UserService extends SimpleUrlLogoutSuccessHandler implements UserDetailsService, LogoutSuccessHandler{
    ...
    final JpaUserRepository uRepo;
    final JpaAccountActivityRepository aRepo;
    public UserService(JpaUserRepository uRepo, JpaAccountActivityRepository aRepo) {
        this.uRepo = uRepo;
        this.aRepo = aRepo;
    }
